...
# ~/.config/tmux/plugins
# eexport PATH=$HOME/.config/tmux/plugins/t-smart-tmux-session-manager/bin:$PATH
...
# Stop ctrl-s for freezing terminal
if [ -t 0 ]; then
    stty stop undef
fi
